            ...
            <el-container>
                ...
                <el-container>
                    <el-main id="doc-container">
                        ...
                        <br/>
                        <DocEditor id="doc-editor" v-model="document" :doc_id="this.doc_id"
                                   :read_only="current_auth.edit===false"/>
                    </el-main>
                    <el-aside width="250px" id="aside_right">
                        <div id="bench_toolbar">
                            <div id="toolbar_title">文档操作</div>
                            <el-divider></el-divider>
                            <el-button class="action-button" type="success" icon="el-icon-lock" @click="save_document">
                                保存文档
                            </el-button>
                            <br/>
                            ...
                            <br/>
                            <el-button class="action-button" type="primary" icon="el-icon-chat-line-square"
                                       @click="openCommentDrawer">评论面板
                            </el-button>
                            <br/>
                            ...
                            <br/>
                            <AuthPopupButton :doc_id="this.doc_id" :belong_to_team="this.belong_team"
                                             :init_self_auth="this.self_auth" :init_team_auth="this.team_auth"/>
                            <el-button class="action-button" type="danger" plain icon="el-icon-delete"
